        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-[#484748]">Generate unique and catchy business names instantly! Our AI-powered tool helps you find the perfect name for your startup, brand, or project—complete with domain availability checks.</h2>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-[#484748]">Effortlessly manage and track job applications. Our system helps recruiters view, sort, and filter applicants based on experience, skills, and application date—making hiring faster and smarter.</h2>
            </div>
          </div>
          <ArrowUpRight className="icon mt-4 mr-2 text-orange-600 absolute top-3 text-2xl right-3 duration-300" />
        </a>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-[#484748]">Stay organized and boost productivity with our Task Manager. Easily create, prioritize, and track tasks in real time—ensuring nothing falls through the cracks.</h2>
            </div>
          </div>
          <ArrowUpRight className="icon mt-4 mr-2 text-orange-600 absolute top-3 text-2xl right-3 duration-300" />
        </a>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-[#484748]">A simple yet powerful image editor built with HTML, CSS, and JavaScript. Edit, crop, apply filters, and enhance images right from your browser—no downloads needed!</h2>
            </div>
          </div>
          <ArrowUpRight className="icon mt-4 mr-2 text-orange-600 absolute top-3 text-2xl right-3 duration-300" />
        </a>
