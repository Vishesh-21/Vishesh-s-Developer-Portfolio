    ...
    <div className="md:mt-28 mt-18 scroll-mt-28" id="projects">
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            {/* Blue overlay and border on hover (desktop only) */}
            <div className="absolute inset-0 z-10 opacity-0 md:group-hover:opacity-100 pointer-events-none transition-opacity duration-300">
              {/* Blue overlay */}
              ...
              <div className="absolute inset-0 md:group-hover:animate-border-run">
              ...
              <img
                ...
                className={`w-full h-full object-cover transition-transform duration-700 ${
                  activeCard === index
                    ...
                    : "md:group-hover:scale-110 md:group-hover:blur-sm md:group-hover:brightness-50"
                }`}
              />
            ...
            {/* Content container - revealed on hover (desktop) or click (mobile) */}
            <div
              className={`absolute inset-0 z-20 flex flex-col justify-center p-6 transition-opacity duration-300 ${
                activeCard === index
                  ? "opacity-100"
      ...
      <motion.div className="text-center mt-12">
        <Button
          className="group bg-white text-black hover:bg-white cursor-pointer transition-all duration-300 hover:scale-[1.03] active:scale-[0.97]"
          onClick={handleClick}
        >
          All Projects
